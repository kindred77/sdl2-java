...
public final class SDL_EventType {
  ...
  public final static SDL_EventType SDL_LOCALECHANGED = new SDL_EventType("SDL_LOCALECHANGED");
  public final static SDL_EventType SDL_DISPLAYEVENT = new SDL_EventType("SDL_DISPLAYEVENT", sdl2javaJNI.SDL_DISPLAYEVENT_get());
  ...
  public final static SDL_EventType SDL_TEXTEDITING_EXT = new SDL_EventType("SDL_TEXTEDITING_EXT");
  ...
  public final static SDL_EventType SDL_JOYBATTERYUPDATED = new SDL_EventType("SDL_JOYBATTERYUPDATED");
  ...
  public final static SDL_EventType SDL_CONTROLLERTOUCHPADDOWN = new SDL_EventType("SDL_CONTROLLERTOUCHPADDOWN");
  public final static SDL_EventType SDL_CONTROLLERTOUCHPADMOTION = new SDL_EventType("SDL_CONTROLLERTOUCHPADMOTION");
  public final static SDL_EventType SDL_CONTROLLERTOUCHPADUP = new SDL_EventType("SDL_CONTROLLERTOUCHPADUP");
  public final static SDL_EventType SDL_CONTROLLERSENSORUPDATE = new SDL_EventType("SDL_CONTROLLERSENSORUPDATE");
  public final static SDL_EventType SDL_CONTROLLERUPDATECOMPLETE_RESERVED_FOR_SDL3 = new SDL_EventType("SDL_CONTROLLERUPDATECOMPLETE_RESERVED_FOR_SDL3");
  public final static SDL_EventType SDL_CONTROLLERSTEAMHANDLEUPDATED = new SDL_EventType("SDL_CONTROLLERSTEAMHANDLEUPDATED");
  ...
  public final static SDL_EventType SDL_AUDIODEVICEADDED = new SDL_EventType("SDL_AUDIODEVICEADDED", sdl2javaJNI.SDL_AUDIODEVICEADDED_get());
  public final static SDL_EventType SDL_AUDIODEVICEREMOVED = new SDL_EventType("SDL_AUDIODEVICEREMOVED");
  public final static SDL_EventType SDL_SENSORUPDATE = new SDL_EventType("SDL_SENSORUPDATE", sdl2javaJNI.SDL_SENSORUPDATE_get());
  public final static SDL_EventType SDL_RENDER_TARGETS_RESET = new SDL_EventType("SDL_RENDER_TARGETS_RESET", sdl2javaJNI.SDL_RENDER_TARGETS_RESET_get());
  public final static SDL_EventType SDL_RENDER_DEVICE_RESET = new SDL_EventType("SDL_RENDER_DEVICE_RESET");
  public final static SDL_EventType SDL_POLLSENTINEL = new SDL_EventType("SDL_POLLSENTINEL", sdl2javaJNI.SDL_POLLSENTINEL_get());
