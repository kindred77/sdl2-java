...
public final class SDL_GLContextResetNotification {
  public final static SDL_GLContextResetNotification SDL_GL_CONTEXT_RESET_NO_NOTIFICATION = new SDL_GLContextResetNotification("SDL_GL_CONTEXT_RESET_NO_NOTIFICATION", sdl2javaJNI.SDL_GL_CONTEXT_RESET_NO_NOTIFICATION_get());
  public final static SDL_GLContextResetNotification SDL_GL_CONTEXT_RESET_LOSE_CONTEXT = new SDL_GLContextResetNotification("SDL_GL_CONTEXT_RESET_LOSE_CONTEXT", sdl2javaJNI.SDL_GL_CONTEXT_RESET_LOSE_CONTEXT_get());
